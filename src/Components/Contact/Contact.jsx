...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "f494b8c2-60bd-4ac5-98d9-c75d8f9b387c");
  ...
  return (
    ...
    <p>Feel free to reach out through contact form or find our contactinformation below. 
       ...
       <ul>
            <li><img src={mail_icon} alt="" />Contact@Gree.dev</li>
    ...
    <form onSubmit={onSubmit}>
        ...
        <button type='submit' className='submit-btn dark-btn'>Submit Now <img src={white_arrow} alt="" /></button>
    </form>
    <span>{result}</span>
    </div>
    </div>
